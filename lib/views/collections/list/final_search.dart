...
class _SearchBarState extends State<FinalSearchBar>
    ...
    return FadeTransition(
      ...
      child: IconButton(
        ...
        onPressed: () {
          ...
          BlocProvider.of<ProductCollectionSearchBloc>(context)
              .add(SearchReset());
        },
      ),
    );
  ...
  void _handleSearchTextChange(BuildContext context, String text) {
    BlocProvider.of<ProductCollectionSearchBloc>(context).add(SearchReset());
    if (text.isNotEmpty) {
      BlocProvider.of<ProductCollectionSearchBloc>(context)
          .add(SearchRequest(text: text));
    }
  }
}
